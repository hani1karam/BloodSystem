...
import UIKit
import MapKit
class FirstType: UIViewController,CLLocationManagerDelegate {
    static func instance () -> FirstType {
         let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
         return storyboard.instantiateViewController(withIdentifier: "FirstType") as! FirstType
     }
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2D(latitude: 29.9285, longitude: 30.9188)
    ...
    static let location = CLLocationCoordinate2D(latitude: 30.0056, longitude: 31.2074482)
    // Giza
    ...
    let omelmasreenhospital = [
        Hospitals(title: "om el massreen hospital", subtitle: "this location in Giza", location: location),
...
extension FirstType: MKMapViewDelegate {
